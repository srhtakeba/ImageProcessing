...
/**
 * A class to represent the operations of a color transformation of an image.
 * A color transformation only changes the hue of each pixel according to the specific
